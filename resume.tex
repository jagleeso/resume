...
\item
	...
	\begin{itemize}
        ...
        \resitem{
            ...
            I measure the performance and energy tradeoffs of protecting against 
            ...
            to prevent leaking AES state, tracking page accesses inside kernel using 
...
\end{tabular*}
        \begin{description}
            \item[Languages:]
                C/C++, \LaTeX, Java, ARM Assembly, Python, Scheme, OCaml, Haskell, MATLAB, 
                R, JavaScript
            \item[Interests:]
